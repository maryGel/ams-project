...
function MvDashBoard(){
    ...
    const numStyles = 'pb-2  mr-2 text-lg font-semibold  cursor-pointer hover:underline hover:drop-shadow-[0_0_0.5rem_gray] transition-transform duration-150 active:translate-y-0.5 hover:scale-x-95';
    const boxStyles = 'p-1 flex justify-between h-auto shadow-md shadow-gray rounded-lg border';

    return (
        <div className='md:hidden'>
            <div className='flex items-center justify-between px-5 pt-10 pb-3 m-4 text-2xl font-semibold tracking-wide bg-blue-100 rounded-md shadow-md'>
            ...
            <div className='grid w-full grid-cols-2 gap-5 px-4 mt-7'>
                
            {dashItems.map(item => 
                <box className={`flex items-end bg-gray-200 ${boxStyles}`}>
