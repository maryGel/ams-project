      ...
      <div  className='p-5'>
        <div className='pt-5 pb-5 text-base shadow-sm shadow-slate-200 bg-gray-50'>
          ...
          <div key= {asset.id} className='flex mt-2'>
            ...
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.Unit} disabled/>
            <span className='p-2 pl-10 text-base tracking-wider text-gray-500'>Quantity:</span>
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.balance_unit} disabled/>
          </div>
          <div className='grid grid-cols-[10rem_1fr] mt-2 mb-8 ml-0 text-base bg-gray-50'>
            ...
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.Brand} disabled/>
            <span className='p-2 pl-5 text-base tracking-wider text-gray-500'>Serial Number:</span>
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.serialNo} disabled/>
            <span className='p-2 pl-5 text-base tracking-wider text-gray-500'>Supplier:</span>
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.suppName} disabled/>
            <span className='p-2 pl-5 text-base tracking-wider text-gray-500'>Reference:</span>
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.ReferenceNo} disabled/>
          </div>
          ...
          <div className='grid grid-cols-[10rem_1fr] mb-8 mt-2 ml-0 text-base bg-gray-50'>
            ...
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.ItemClass} disabled/>
            ...
            <input type= 'text' className='p-2 text-base text-gray-500' value={asset.Department} disabled/>
            <span className='p-2 pl-5 text-base tracking-wider text-gray-500'>Assigned to:</span>
            <span className='p-2 text-base text-gray-500'>mcagulada</span>
          </div>
